...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        CfnHealthCheck authDbHealthCheck =
                createDbHealthCheck(authServiceDb, "auth-service-db");

        CfnHealthCheck patientDbHealthCheck =
                createDbHealthCheck(patientServiceDb, "patient-service-db");
        ...
        FargateService authService =
                createFargateService("AuthService", "auth-service",
                        List.of(4005),
                        authServiceDb,
                        Map.of("JWT_SECRET", "YmFycGVuc2FsdHR1YmVuYWlsc3NpbHZlcmJleW9uZGNvbnZlcnNhdGlvbmF2ZXJhZ2U=")
                );
        ...
        FargateService patientService =
                createFargateService("PatientService", "patient-service",
                        ...
                        Map.of(
                                ...
                                "SPRING_FLYWAY_URL", "jdbc:postgresql://%s:%s/%s-db".formatted(
                                        patientServiceDb.getDbInstanceEndpointAddress(),
                                        patientServiceDb.getDbInstanceEndpointPort(),
                                        "patient-service"),
                                "SPRING_FLYWAY_USER", "admin_user",
                                "SPRING_FLYWAY_PASSWORD", Objects.requireNonNull(
                                        patientServiceDb.getSecret())
        ...
        return CfnCluster.Builder
                ...
                .brokerNodeGroupInfo(CfnCluster.BrokerNodeGroupInfoProperty.builder()
                        ...
                        .clientSubnets(vpc.getPrivateSubnets()
                                .stream().map(ISubnet::getSubnetId).collect(Collectors.toList()))
    ...
    private FargateService createFargateService(
        ...
        if (db != null) {
            ...
            envVars.put("SPRING_DATASOURCE_HIRAKI_INITIALIZATION_FAIL_TIMEOUT", "60000");
        }
